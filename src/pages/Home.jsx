...
function Home() {
  ...
  const productsDetails = [
    ...
    },
    {
      ...
      name: "Lauren",
      price: "69$",
      imageUrl: "https://via.placeholder.com/150/87CEEB/000000",
      rating: 5.0,
    },
  ];
  ...
  return (
    <div>
      ...
      {/* Shop Product */}
      <div className="w-screen px-20 my-20 relative">
        {" "}
        {/* Changed absolute to relative */}
        <h1 className="text-4xl font-bold">Shop Product By</h1>
        <div className="flex flex-col md:flex-row items-center bg-primary rounded-2xl mx-auto my-14 md:w-10/12">
          <div className="flex-shrink-0 relative top-16">
            <img
              src={IphomeImg}
              alt="Product"
              className="w- h-auto md:w-11/12"
            />
          </div>
          <div className="mt-6 md:mt-0 md:ml-8 md:max-w-md">
            <h2 className="text-4xl font-bold text-black mb-4">
              Defin yourself be different
            </h2>
            <p className="text-gray-600 mb-6 pr-28">
              These have large ear cups that encompass the ears, providing good
              sound isolation and often better sound quality.
            </p>
            <button className="bg-[#EC3D2F] text-white py-2 px-4 rounded-lg hover:bg-red-600">
              Shop now &rarr;
            </button>
          </div>
        </div>
        ...
        <div className="mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {productsDetails.map((product) => (
              <div
                key={product.id}
                className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center justify-between hover:shadow-xl transition-shadow"
              >
                <img
      ...
      <div className="h-screen mx-auto px-8 py-8">
        <h1 className="text-3xl font-bold text-center mb-8">
          Top Rated Products
        </h1>
        <div className="h-2/3 flex flex-col md:flex-row gap-6">
          {/* Left Product Card */}
          <div className="bg-primary rounded-2xl overflow-hidden shadow-lg py-4 w-full flex items-center md:w-2/3 ">
            <div className="flex  ">
              <img
          ...
          {/* Right Product Card */}
          <div className="bg-primary rounded-2xl overflow-hidden shadow-lg px-8 py-4 w-full md:">
            <div className="w-10/12 flex flex-row justify-between items-center">
              <div className="flex flex-col gap-10">
                <div className="mt-4 ">
                  <h2 className="text-5xl font-bold text-gray-800">Smart</h2>
                  <h2 className="text-5xl font-bold text-gray-800">Watches</h2>
                </div>
                <PrimaryBtn />
              </div>
      ...
      <div className="w-full bg-primary p-4 sm:p-6 flex justify-end items-center">
        <div className="w-3/4 flex justify-between py-8">
          <p className="text-lg sm:text-4xl font-bold text-black">
            10% off when paying with a debit card
          </p>
          <FiTag className="h-14 w-8 text-black " />
        </div>
      </div>

      {/* User's-Section */}
      <div className="w-screen flex flex-col-reverse md:flex-row items-center justify-between max-w-screen-2xl mx-auto py-24 px-4 md:px-8">
        {/* Text and Stats */}
        <div className="md:w-1/2 ">
          <h3 className="text-red-500 font-bold text-sm md:text-4xl mb-2">
            Comment level
          </h3>
          <h1 className="text-black font-bold text-3xl md:text-7xl mb-6">
            A new style in your Ear
          </h1>
          <div className="grid grid-cols-2 gap-4 px-8 ">
            <div className="bg-[#BCCDE0] p-4 rounded-2xl shadow-md text-center py-6">
              <p className="text-red-500 text-7xl font-bold">4M+</p>
              <p className="text-black text-4xl font-bold font-sans">User's</p>
            </div>
            <div className="bg-[#BCCDE0] p-4 rounded-2xl shadow-md text-center">
              <p className="text-red-500 text-7xl font-bold">153k</p>
              <p className="text-black text-4xl font-bold font-sans">
                Purchaser
              </p>
            </div>
            <div className="bg-[#BCCDE0] p-4 rounded-2xl shadow-md text-center">
              <p className="text-red-500 text-7xl font-bold">53k</p>
              <p className="text-black text-4xl font-bold font-sans">Gallery</p>
            </div>
            <div className="bg-[#BCCDE0] p-4 rounded-2xl shadow-md text-center">
              <p className="text-red-500 text-7xl font-bold">2M+</p>
              <p className="text-black text-4xl font-bold font-sans">
                Feedback
              </p>
            </div>
        ...
        {/* Image */}
        <div className="relative md:w-1/2 md:h-96 mb-10 md:mb-0  flex items-center justify-end">
        <div className="h-72 w-[70%] bg-red-500 rounded-s-[80%] flex justify-center items-center"
        style={{ transform: "" }}>
          ...
          {/* <div className="absolute left-0 top-0 inset-0 bg-red-500 rounded-s-3xl  transform translate-x-1/4 translate-y-1/4 md:translate-x-1/2 md:translate-y-1/2"></div> */}
