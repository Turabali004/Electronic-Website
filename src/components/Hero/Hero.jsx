...
import { PrimaryBtn, Header } from '../index';
    ...
    <div className="font-sans relative bg-white">
      ...
      <main className="w-full flex flex-col md:flex-row justify-between h-screen">
        ...
        <div className="w-full md:w-2/4 flex flex-col items-start justify-center text-left mt-12 md:mt-0 px-8 md:px-16">
          <h2 className="text-base text-secondary font-semibold uppercase mb-2">In the spotlight</h2>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight text-black mb-4">Your sound best for your life</h1>
